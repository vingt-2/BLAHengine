...
namespace BLA
{
    ...
    void RegisterRenderPassInstance(const System::Vulkan::WindowInfo* vulkanWindoInfo,
        ...
        void BuildCommandBuffers(blaVector<VulkanRenderPassInstance>& renderPassInstance, System::Vulkan::WindowInfo* vkWindow) const
        {
            ...
            for (int32_t i = 0; i < vkWindow->m_frames.size(); ++i)
            {
                ...
                {
                    vkCmdBindVertexBuffers(vkWindow->m_frames[i].m_commandBuffer, 0, (blaU32)instance.m_vertexBuffers.size(), instance.m_vertexBuffers.data(), nullptr);
