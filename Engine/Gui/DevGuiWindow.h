...
namespace BLA
{
    ...
    {
    public:
        BLACORE_API DevGuiRenderViewportWindow(Renderer* renderer, const blaString& windowName, const blaIVec2& windowPosition);
    ...
    private:
        ...
        void UpdateDisplayTexture(Renderer* renderer);
