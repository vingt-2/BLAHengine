...
void GameObjectInspector::InspectGameObject(GameObjectReference gameObject)
{
...
std::vector<blaString> GameObjectInspector::GetComponents(GameObjectReference gameObject)
{
