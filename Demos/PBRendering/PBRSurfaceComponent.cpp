...
float BLA::PBRMaterial::LambertianBRDF::SampleBRDF(blaVec3& outDir, blaMat3& tangentSpace, blaVec3& inDir)
{
...
float BLA::PBRMaterial::MirrorBRDF::SampleBRDF(blaVec3& outDir, blaMat3& tangentSpace, blaVec3 & inDir)
{
