...
//    }
//    m_renderedImage = m_renderer->Render(GetOwnerObject().GetComponent<TransformComponent>()->GetTransform().GetPosQuat(), resolution, PARALLEL_RENDER);
//    WriteImageToFile("image.ppm", resolution.x, resolution.y);
//    m_shouldRender = false;
//}
//
//bool BLA::PBRCamera::WriteImageToFile(blaString filepath, int w, int h)
//{
...
//}
//
//blaPair<MeshRendererComponent*, ColliderComponent::CollisionContact> PBRRenderer::IntersectWithScene(Ray ray, blaVector<MeshRendererComponent*> &surfaceComponents)
//{
//    float minDistance = INFINITY;
//    MeshRendererComponent* pickedObject = nullptr;
...
//}
//
//blaVector<blaVec3> BLA::PBRExplicitPathTracer::Render(ObjectTransform cameraTransform, glm::vec2 resolution, bool inParallel)
//{
...
//}
//
//blaVec3 BLA::PBRExplicitPathTracer::PathTraceShade(Ray incidentRay, int depth)
//{
//    if (depth > 1)
//    {
//        return blaVec3(0);
...
//}
//
//void BLA::PBRPhotonMapping::BuildPhotonMap(bool inParallel, blaU32 numberOfPhotons)
//{
...
//}
//
//Ray BLA::PBRPhotonMapping::GeneratePhoton(PBRSurfaceComponent* lightSurface, float &outEmissionProb)
//{
...
//}
//
//void BLA::PBRPhotonMapping::TracePhoton(Ray incidentRay, blaVec3 photonPower, int bounce)
//{
//    if (bounce > 10)
//        return;
//
...
//}
//
//blaVec3 BLA::PBRPhotonMapping::GatherSurfaceDensity(Ray incidentRay)
//{
//    auto p = IntersectWithScene(incidentRay, m_sceneObjects);
//
//    PBRMaterial* m = &(p.first->m_material);
...
//}
//
//blaVec3 BLA::PBRPhotonMapping::GatherVolumetricDensity(blaVec3 pos, blaVec3 incomingDir)
//{
//    float gatherAreaRadius;
...
//}
//
//blaVec3 BLA::PBRPhotonMapping::MarchIndirectVolumetric(Ray ray, float endOfRay, int numberOfSamples)
//{
//    blaVec3 indirectRadiance(0);
...
//}
//
//blaVec3 BLA::PBRPhotonMapping::MarchDirectEquiAngular(Ray ray, float endOfRay, int numberOfSamples)
//{
//    float dt = endOfRay / (float)numberOfSamples;
//    float marchedDistance = dt;
//    blaVec3 indirectRadiance(0);
...
//}
//
//blaVec3 BLA::PBRPhotonMapping::Shade(Ray incidentRay)
//{
//    auto p = IntersectWithScene(incidentRay, m_sceneObjects);
//
//    if (p.first == nullptr)
...
//}
//
//blaVector<blaVec3> BLA::PBRPhotonMapping::Render(ObjectTransform cameraTransform, glm::vec2 resolution, bool inParallel)
//{
//    for (PBRSurfaceComponent* surface : m_sceneObjects)
//    {
//        if (length(surface->m_material.m_emissivePower) > 0.0f)
